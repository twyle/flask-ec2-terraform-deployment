# A Flask App Deployment Pipeline

> A deployment pipeline for deploying a python application to AWS EC2 provisioned using terraform and configured using ansible.
...
<img src="assets/images/flask_app.png" class="img-responsive" alt="">
